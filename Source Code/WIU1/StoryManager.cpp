...
StoryManager::StoryManager() :
       ...
       zombieNPC("Iris", "A survivor who is looking for help", 18, 6, 'i', "There is a bunch of zombies in the city, please kill them before they attack anyone else!", &killZombieQuest),

       missingpersonNPC("Hank", "A police officer searching for a missing civilian", 4, 14, 'h', "Someone went missing during the outbreak. Please find them and bring them back to me.", &findMissingPersonQuest),

       pharmacyNPC("Dr. Chen", "A doctor who is looking for a cure", 18, 13, 'd', "I need to get the Temozolomide from the pharmacy section of the supermarket. Please help to retrieve it and bring it back to me", &findPharmacyQuest) {}
